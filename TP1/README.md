...
<img src="README_files/figure-gfm/densidad-1.png" alt="Densidad de probabilidad conjunta $p(x, y) = \mathcal{N}(\sin(2\pi x), 0.3)$. En negro, la línea $\mathbb{E}(y|x)$."  />
...
<img src="README_files/figure-gfm/unnamed-chunk-2-1.png" alt="Cuatro ejemplos de conjuntos de datos generados por la función `D` con `n = 40`. En línea negra, la función $t = \sin(2\pi x)$"  />
...
<img src="README_files/figure-gfm/ajustes-orden-1.png" alt="Ajustes polinomiales con distintos órdenes y lambda = 0 para 1 ejemplo. La línea negra representa la función real. Al aumentar el grado del polinomio, el ajuste se acerca más a los puntos observados pero oscila alocadamente lejos de ellos."  />
...
<img src="README_files/figure-gfm/ajustes-lambda-1.png" alt="Igual que la figura anterior, pero con orden fijo = 8 y lambda variable. Al aumentar el factor de regularización, el modelo se simplifica. Aumenta la diferencia con los datos usados para el ajuste, pero mejora la generalización."  />
...
<img src="README_files/figure-gfm/rmse-sd-1.png" alt="Histograma de la raiz del error cuadrático medio computado para 200 muestras de `n = 10`."  />
...
<img src="README_files/figure-gfm/rmse-orden-1.png" alt="Mediana (en negro) y promedio (en violeta) del RMSE de validación cruzada e intervalo de confianza de 95\%. Datos ordenados de menor a mayor a partir de la mediana del RMSE."  />
...
<img src="README_files/figure-gfm/rmse-test-1.png" alt="Histograma del RSME de test de los 50 sets de datos no utilizados para validación cruzada."  />
