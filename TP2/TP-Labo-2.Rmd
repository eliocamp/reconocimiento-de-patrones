...
```{r logistica-lineal, fig.cap = "Convergencia del modelo logístico lineal. En contornos negros, el nivel de confianza del modelo.", fig.height=5, fig.width=6}
...
```{r logistica-eliptica, fig.cap = "Igual que la Figura  pero para un ajuste elíptico.", fig.height=5, fig.width=6}
