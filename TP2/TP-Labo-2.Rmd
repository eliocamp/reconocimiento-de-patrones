...
```{r em-pinguinos, fig.cap = "Medias y elipses normales representando el cuantil del 95% para los clusters identificados por Expectation Maximisation con k = 2 (izquierda) y k = 3 (derecha)."}
set.seed(123)
